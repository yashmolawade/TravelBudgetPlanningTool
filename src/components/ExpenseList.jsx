      ...
      <div className="card bg-white dark:bg-gray-900">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-6">
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="input-field pl-10 bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
              />
            </div>
          </div>
          ...
          <div className="md:w-48">
            <div className="relative">
              <Filter className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 dark:text-gray-300 h-4 w-4" />
              <select
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="btn-primary text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                      >
                        Save
                      </button>
                      <button
                        onClick={handleCancelEdit}
                        className="btn-secondary text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex space-x-2 ml-4">
                      <button
                        ...
                        className="p-2 text-gray-400 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 transition-colors"
                      >
